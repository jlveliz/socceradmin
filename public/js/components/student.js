$(document).ready(function() {
    ...
    formatDomSelect = (data) => {
        ...
        data.forEach(element => {
            ...
            htmlReturn += element.coach.username + ' - ' + element.range.name + ' - ' + element.disponibility + ' Cupos Disponibles<span class="text-secondary"><i> - ' + element.day + ' - (' + element.schedule.start + ' - ' + element.schedule.end + ') </i></span> '
            htmlReturn += "</option>";
        });
