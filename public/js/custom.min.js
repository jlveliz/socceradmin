    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        */
        $('#delete-modal').on('show.bs.modal',(event)=>{
            ...
            let route = btnDelete.data('url');
            let component = btnDelete.data('component');
            let componentName = btnDelete.data('component-name');
            let txtToShow =  component + ' de <b>' + componentName+'</b>';
            modal.find('.modal-body span').html(txtToShow);
