$(function() {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        $(".delete-item").on('click', function(event) {
            ...
            let modalDelete = $("#delete-item-modal");
            let _this = $(this);
            let message = _this.data('message');
            let object =  _this.data('object');
            let route =  _this.data('route');


            modalDelete.find('.modal-body span.modal-message').text(message)
            modalDelete.find('.modal-body strong.modal-item-name').text(object.name);
            modalDelete.find('.modal-footer form').attr('action',route);
