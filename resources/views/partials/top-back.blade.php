            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ url('backend/dashboard') }}">
                        <!-- Logo icon -->
                        <b><img src="{{ asset('images/logo.png') }}" style="width: 70%" alt="{{ config('app.name') }}" class="dark-logo" /></b>
                    </a>
                </div>
                <!-- End Logo -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li>
                                        <a href="#" class="logout-btn"><i class="fa fa-power-off"></i> Salir</a>
                                        <form action="{{ route('logout') }}" method="POST" id="logout-form">
                                            {{ csrf_field() }}
                                            <input type="submit" class="d-none" name="logout">
                                        </form>
                                    </li>
                                </ul>
                            </div>
