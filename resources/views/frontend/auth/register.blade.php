                    ...
                    <div class="elementor-widget-container">
                        <form class="elementor-form" method="post" id="registro-form" name="Registro" action="{{ route('register-user-post') }}">
                            ...
                            <div class="elementor-form-fields-wrapper elementor-labels-">
                               ...
                               <div class="elementor-element elementor-element-fb7f165 elementor-widget elementor-widget-alert  elementor-column elementor-col-100" data-id="fb7f165" style="display: none" id="alert-message" data-element_type="widget" data-widget_type="alert.default">
                                    <div class="elementor-widget-container">
                                ...
                                <div class="elementor-element  elementor-column elementor-element-59bc091 elementor-align-center elementor-icon-list--layout-traditional elementor-widget elementor-widget-icon-list elementor-col-100" data-id="59bc091" data-element_type="widget" data-widget_type="icon-list.default">
                                    <div class="elementor-widget-container">
